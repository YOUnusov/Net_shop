...
<div class="panel panel-default box-product">
	...
	<div id="xds-latest<?php echo $module; ?>" class="panel-body">
	...
	<script type="text/javascript">
		$('#xds-latest<?php echo $module; ?>').owlCarousel({
			responsiveBaseWidth: '#xds-latest<?php echo $module; ?>',
		...
		$('#xds-latest-clock-m<?php echo $module; ?>-p<?php echo $product['product_id']; ?>').countdown('<?php echo $product['date_end']; ?>', function(event) {
