    ...
    <div id="content" class="<?php echo $class; ?>">
			...
			<div class="row">
				<div class="col-md-3 col-sm-6">
					<div class="well">
						<div class="media">
							<div class="pull-left"><i class="fa fa-credit-card card-icon"></i></div>
							<div class="media-body">
								<?php echo $text_user_balance; ?>
								<h4 class="media-heading"><a href="<?php echo $transaction; ?>"><?php echo $user_balance; ?></a></h4>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 col-sm-6">
					<div class="well">
						<div class="media">
							<div class="pull-left"><i class="fa fa-diamond card-icon"></i></div>
							<div class="media-body">
								<?php echo $text_user_points; ?>
								<h4 class="media-heading"><a href="<?php echo $reward; ?>"><?php echo $user_points; ?></a></h4>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 col-sm-6">
					<div class="well">
						<div class="media">
							<div class="pull-left"><i class="fa fa-heart-o card-icon"></i></div>
							<div class="media-body">
								<?php echo $text_user_wishlist_total; ?>
								<h4 class="media-heading"><a href="<?php echo $wishlist; ?>"><?php echo $user_wishlist_total; ?></a></h4>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="panel panel-default">
						...
						<div class="list-group">
							...
							<a class="list-group-item" href="<?php echo $wishlist; ?>"><i class="fa fa-heart-o list-group-icon"></i>&nbsp;&nbsp;<?php echo $text_wishlist; ?></a>
				...
				<div class="col-md-6">
					<div class="panel panel-default">
						...
						<div class="list-group">
							...
							<a class="list-group-item" href="<?php echo $download; ?>"><i class="fa fa-download list-group-icon"></i>&nbsp;&nbsp;<?php echo $text_download; ?></a>
							<?php if ($reward) { ?>
							...
							<a class="list-group-item" href="<?php echo $transaction; ?>"><i class="fa fa-credit-card list-group-icon"></i>&nbsp;&nbsp;<?php echo $text_transaction; ?></a>
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading"><h3 class="panel-title"><?php echo $text_credit_card; ?></h3></div>
						<div class="list-group">
