        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php if ($products[$product['product_id']]['price']) { ?>
              ...
              <?php } else { ?>
              <span class="price-old" style="color:#e4003a; text-decoration:line-through"><?php echo $products[$product['product_id']]['price']; ?> </span> <span class="price-new"> <?php echo $products[$product['product_id']]['special']; ?> </span>
              <?php } ?>
              <?php } ?></td>
            <?php } ?>
          </tr>
