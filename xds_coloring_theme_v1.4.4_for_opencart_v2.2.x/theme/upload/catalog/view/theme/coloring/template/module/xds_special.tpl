...
<div class="panel panel-default box-product">
	...
	<div id="xds-special<?php echo $module; ?>" class="panel-body">
		...
		<div class="product-item">
			<div class="image">
				...
				<div class="sticker st-sale <?php if ($product['date_end']) { echo 'with-date'; }?>" ><?php echo $product['discount']; ?>&#37;</div>
				<?php } ?>
			</div>
			<div class="caption">
	...
	<script type="text/javascript">
		$('#xds-special<?php echo $module; ?>').owlCarousel({
			responsiveBaseWidth: '#xds-special<?php echo $module; ?>',
		...
		$('#xds-special-clock-m<?php echo $module; ?>-p<?php echo $product['product_id']; ?>').countdown('<?php echo $product['date_end']; ?>', function(event) {
