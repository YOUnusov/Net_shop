...
class ControllerModuleXDSSpecial extends Controller {
	public function index($setting) {
		...
		if ($results) {
			...
			$data['module'] = $module++;
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/xds_special.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/module/xds_special.tpl', $data);
			} else {
				return $this->load->view('default/template/module/xds_special.tpl', $data);
			}
		}
	}
}