<?php
class ControllerThemeColoring extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('theme/coloring');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('coloring', $this->request->post, $this->request->get['store_id']);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('theme/coloring', 'token=' . $this->session->data['token'] . '&store_id=' . $this->request->get['store_id'], true)
		);

		$data['action'] = $this->url->link('theme/coloring', 'token=' . $this->session->data['token'] . '&store_id=' . $this->request->get['store_id'], true);

		$data['cancel'] = $this->url->link('extension/theme', 'token=' . $this->session->data['token'], true);

		if (isset($this->request->get['store_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$setting_info = $this->model_setting_setting->getSetting('coloring', $this->request->get['store_id']);
		}
		...
		if (isset($this->request->post['coloring_status'])) {
			...
			$data['coloring_status'] = $this->config->get('coloring_status');
		} else {
		...
		if (isset($this->request->post['coloring_product_description_length'])) {
			...
			$data['coloring_product_description_length'] = $this->config->get('coloring_product_description_length');
		} else {
		...
		if (isset($this->request->post['coloring_image_category_width'])) {
			...
			$data['coloring_image_category_width'] = $this->config->get('coloring_image_category_width');
		} else {
		...
		if (isset($this->request->post['coloring_image_category_height'])) {
			...
			$data['coloring_image_category_height'] = $this->config->get('coloring_image_category_height');
		} else {
		...
		if (isset($this->request->post['coloring_image_thumb_width'])) {
			...
			$data['coloring_image_thumb_width'] = $this->config->get('coloring_image_thumb_width');
		} else {
		...
		if (isset($this->request->post['coloring_image_thumb_height'])) {
			...
			$data['coloring_image_thumb_height'] = $this->config->get('coloring_image_thumb_height');
		} else {
		...
		if (isset($this->request->post['coloring_image_popup_width'])) {
			...
			$data['coloring_image_popup_width'] = $this->config->get('coloring_image_popup_width');
		} else {
		...
		if (isset($this->request->post['coloring_image_popup_height'])) {
			...
			$data['coloring_image_popup_height'] = $this->config->get('coloring_image_popup_height');
		} else {
		...
		if (isset($this->request->post['coloring_image_product_width'])) {
			...
			$data['coloring_image_product_width'] = $this->config->get('coloring_image_product_width');
		} else {
		...
		if (isset($this->request->post['coloring_image_product_height'])) {
			...
			$data['coloring_image_product_height'] = $this->config->get('coloring_image_product_height');
		} else {
		...
		if (isset($this->request->post['coloring_image_additional_width'])) {
			...
			$data['coloring_image_additional_width'] = $this->config->get('coloring_image_additional_width');
		} else {
		...
		if (isset($this->request->post['coloring_image_additional_height'])) {
			...
			$data['coloring_image_additional_height'] = $this->config->get('coloring_image_additional_height');
		} else {
		...
		if (isset($this->request->post['coloring_image_related_width'])) {
			...
			$data['coloring_image_related_width'] = $this->config->get('coloring_image_related_width');
		} else {
		...
		if (isset($this->request->post['coloring_image_related_height'])) {
			...
			$data['coloring_image_related_height'] = $this->config->get('coloring_image_related_height');
		} else {
		...
		if (isset($this->request->post['coloring_image_compare_width'])) {
			...
			$data['coloring_image_compare_width'] = $this->config->get('coloring_image_compare_width');
		} else {
		...
		if (isset($this->request->post['coloring_image_compare_height'])) {
			...
			$data['coloring_image_compare_height'] = $this->config->get('coloring_image_compare_height');
		} else {
		...
		if (isset($this->request->post['coloring_image_wishlist_width'])) {
			...
			$data['coloring_image_wishlist_width'] = $this->config->get('coloring_image_wishlist_width');
		} else {
		...
		if (isset($this->request->post['coloring_image_wishlist_height'])) {
			...
			$data['coloring_image_wishlist_height'] = $this->config->get('coloring_image_wishlist_height');
		} else {
		...
		if (isset($this->request->post['coloring_image_cart_width'])) {
			...
			$data['coloring_image_cart_width'] = $this->config->get('coloring_image_cart_width');
		} else {
		...
		if (isset($this->request->post['coloring_image_cart_height'])) {
			...
			$data['coloring_image_cart_height'] = $this->config->get('coloring_image_cart_height');
		} else {
		...
		if (isset($this->request->post['coloring_image_location_width'])) {
			...
			$data['coloring_image_location_width'] = $this->config->get('coloring_image_location_width');
		} else {
		...
		if (isset($this->request->post['coloring_image_location_height'])) {
			...
			$data['coloring_image_location_height'] = $this->config->get('coloring_image_location_height');
		} else {
		...
		$this->response->setOutput($this->load->view('theme/coloring', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'theme/coloring')) {
