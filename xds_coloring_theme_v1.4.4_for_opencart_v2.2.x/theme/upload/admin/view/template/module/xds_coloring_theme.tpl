							...
							<div class="tab-content">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="main_menu_toggle" value="1" <?php if ($main_menu_toggle) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="main_menu_toggle" value="0" <?php if (!$main_menu_toggle) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
													...
													<tr id="item-row-main<?php echo $item_row_main; ?>">
														<td class="text-left">
															...
															<div class="input-group pull-left">
																...
																<input class="form-control" type="text" name="main_menu_item[<?php echo $item_row_main; ?>][title][<?php echo $language['language_id']; ?>]" value="<?php echo $main_menu_item['title'][$language['language_id']]; ?>" />
															</div>
															<?php } ?>
														</td>
														<td class="text-left">
															...
															<div class="input-group pull-left">
																<span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
																	<input class="form-control" type="text" name="main_menu_item[<?php echo $item_row_main; ?>][link][<?php echo $language['language_id']; ?>]" value="<?php echo $main_menu_item['link'][$language['language_id']]; ?>" />
															</div>
															<?php } ?>
														</td>
														<td class="text-left">
															<input  class="form-control" type="text" name="main_menu_item[<?php echo $item_row_main; ?>][sort]" value="<?php echo $main_menu_item['sort']; ?>" />
														</td>
														<td class="text-right">
								...
								<div class="tab-pane" id="tab-help-menu">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="help_menu_toggle" value="1" <?php if ($help_menu_toggle) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="help_menu_toggle" value="0" <?php if (!$help_menu_toggle) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="help_menu_left" value="1" <?php if ($help_menu_left) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="help_menu_left" value="0" <?php if (!$help_menu_left) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<div class="input-group">
												...
												<input name="help_menu_text[<?php echo $language['language_id']; ?>]" value="<?php echo $help_menu_text[$language['language_id']]; ?>" class="form-control" />
											</div>
											<?php } ?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<table id="help-menu-items" class="table table-bordered">
												...
												<tbody>
												<?php $item_row_help = 0; ?>
												<?php foreach ($help_menu_items as $help_menu_item) { ?>
													<tr id="item-row-help<?php echo $item_row_help; ?>">
														<td class="text-left">
															<?php foreach ($languages as $language) { ?>
															<div class="input-group pull-left">
																<span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
																<input class="form-control" type="text" name="help_menu_item[<?php echo $item_row_help; ?>][title][<?php echo $language['language_id']; ?>]" value="<?php echo $help_menu_item['title'][$language['language_id']]; ?>" />
															</div>
															<?php } ?>
														</td>
														<td class="text-left">
															...
															<div class="input-group pull-left">
																<span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
																	<input class="form-control" type="text" name="help_menu_item[<?php echo $item_row_help; ?>][link][<?php echo $language['language_id']; ?>]" value="<?php echo $help_menu_item['link'][$language['language_id']]; ?>" />
															</div>
															<?php } ?>
														</td>
														<td class="text-left">
															<input  class="form-control" type="text" name="help_menu_item[<?php echo $item_row_help; ?>][sort]" value="<?php echo $help_menu_item['sort']; ?>" />
														</td>
														<td class="text-right">
								...
								<div class="tab-pane" id="tab-header-category-menu">
									<div class="form-group">
										<label class="col-sm-2 control-label">Маска при наведении (затемнение страницы)</label>
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="category_mask_toggle" value="1" <?php if ($category_mask_toggle) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="category_mask_toggle" value="0" <?php if (!$category_mask_toggle) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="add_cat_links_toggle" value="1" <?php if ($add_cat_links_toggle) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="add_cat_links_toggle" value="0" <?php if (!$add_cat_links_toggle) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<table id="category-links-items" class="table table-bordered">
												...
												<?php foreach ($add_cat_links_items as $add_cat_links_item) { ?>
													<tr id="item-row-cat-links<?php echo $item_row_cat_links; ?>">
														<td class="text-left">
															<?php foreach ($languages as $language) { ?>
															<div class="input-group pull-left">
																<span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
																<input class="form-control" type="text" name="add_cat_links_item[<?php echo $item_row_cat_links; ?>][title][<?php echo $language['language_id']; ?>]" value="<?php echo $add_cat_links_item['title'][$language['language_id']]; ?>" />
															</div>
															<?php } ?>
														</td>
														<td class="text-left">
															...
															<div class="input-group pull-left">
																<span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
																	<input class="form-control" type="text" name="add_cat_links_item[<?php echo $item_row_cat_links; ?>][link][<?php echo $language['language_id']; ?>]" value="<?php echo $add_cat_links_item['link'][$language['language_id']]; ?>" />
															</div>
															<?php } ?>
														</td>
														<td class="text-left">
															<input  class="form-control" type="text" name="add_cat_links_item[<?php echo $item_row_cat_links; ?>][sort]" value="<?php echo $add_cat_links_item['sort']; ?>" />
														</td>
														<td class="text-right">
								...
								<div class="tab-pane" id="tab-header-contacts">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="contact_main_toggle" value="1" <?php if ($contact_main_toggle) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="contact_main_toggle" value="0" <?php if (!$contact_main_toggle) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<div class="input-group">
												...
												<input name="contact_main_phone[<?php echo $language['language_id']; ?>]" value="<?php echo $contact_main_phone[$language['language_id']]; ?>" class="form-control" />
											</div>
											<?php } ?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<div class="input-group">
												...
												<input name="contact_hint[<?php echo $language['language_id']; ?>]" value="<?php echo $contact_hint[$language['language_id']]; ?>" class="form-control" />
											</div>
											<?php } ?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="contact_add_toggle" value="1" <?php if ($contact_add_toggle) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="contact_add_toggle" value="0" <?php if (!$contact_add_toggle) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
											...
											<table id="header-contacts-items" class="table table-bordered">
												...
												<?php foreach ($header_contacts as $header_contact) { ?>
													<tr id="item-row-cont<?php echo $cont_item_row; ?>">
														<td class="text-left">
															<a href="" id="thumb-image-cont<?php echo $cont_item_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $header_contact['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>"  /></a><input type="hidden" name="header_contact[<?php echo $cont_item_row; ?>][image]" value="<?php echo $header_contact['image']; ?>" id="input-image-cont<?php echo $cont_item_row; ?>" />
														</td>
														<td class="text-left">
															<?php foreach ($languages as $language) { ?>
															<div class="input-group pull-left">
																<span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
																<input class="form-control" type="text" name="header_contact[<?php echo $cont_item_row; ?>][title][<?php echo $language['language_id']; ?>]" value="<?php echo $header_contact['title'][$language['language_id']]; ?>" />
															</div>
															<?php } ?>
														</td>
														<td class="text-left">
															<input  class="form-control" type="text" name="header_contact[<?php echo $cont_item_row; ?>][sort]" value="<?php echo $header_contact['sort']; ?>" />
														</td>
														<td class="text-right">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<div class="input-group">
												...
												<input name="contact_email[<?php echo $language['language_id']; ?>]" value="<?php echo $contact_email[$language['language_id']]; ?>" class="form-control" />
											</div>
											<?php } ?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<div class="input-group">
												...
												<textarea name="schedule[<?php echo $language['language_id']; ?>]" rows="1" class="form-control"><?php echo $schedule[$language['language_id']]; ?></textarea>
											</div>
											<?php } ?>
										</div>
									</div>
											...
											<table id="header-add-contacts-items" class="table table-bordered">
												...
												<?php foreach ($additional_contacts as $additional_contact) { ?>
													<tr id="item-row-add-cont<?php echo $add_cont_item_row; ?>">
														<td class="text-left">
															<a href="" id="thumb-image-add-cont<?php echo $add_cont_item_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $additional_contact['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>"  /></a><input type="hidden" name="additional_contact[<?php echo $add_cont_item_row; ?>][image]" value="<?php echo $additional_contact['image']; ?>" id="input-image-add-cont<?php echo $add_cont_item_row; ?>" />
														</td>
														<td class="text-left">
															<?php foreach ($languages as $language) { ?>
															<div class="input-group pull-left">
																<span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
																<input class="form-control" type="text" name="additional_contact[<?php echo $add_cont_item_row; ?>][title][<?php echo $language['language_id']; ?>]" value="<?php echo $additional_contact['title'][$language['language_id']]; ?>" />
															</div>
															<?php } ?>
														</td>
														<td class="text-left">
															...
															<div class="input-group pull-left">
																<span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
																<input class="form-control" type="text" name="additional_contact[<?php echo $add_cont_item_row; ?>][link][<?php echo $language['language_id']; ?>]" value="<?php echo $additional_contact['link'][$language['language_id']]; ?>" />
															</div>
															<?php } ?>
														</td>
														<td class="text-left">
															<input  class="form-control" type="text" name="additional_contact[<?php echo $add_cont_item_row; ?>][sort]" value="<?php echo $additional_contact['sort']; ?>" />
														</td>
														<td class="text-right">
										...
										<div class="col-sm-10">
											<table id="new-home-module" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php foreach ($new_home_layout_modules as $new_home_layout_module) { ?>
													<tr id="new-home-module-row<?php echo $new_home_module_row; ?>">
														<td>
															<select name="new_home_layout_module[<?php echo $new_home_module_row; ?>][code]" class="form-control">
																<?php foreach ($new_home_extensions as $extension) { ?>
																<?php if (!$extension['module']) { ?>
																<?php if ($extension['code'] == $new_home_layout_module['code']) { ?>
																...
																<?php if ($module['code'] == $new_home_layout_module['code']) { ?>
														...
														<td>
															<input type="text" name="new_home_layout_module[<?php echo $new_home_module_row; ?>][sort_order]" value="<?php echo $new_home_layout_module['sort_order']; ?>" placeholder="" class="form-control" />
														</td>
														<td>
								...
								<div class="tab-pane" id="tab-footer-map">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="footer_map_toggle" value="1" <?php if ($footer_map_toggle) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="footer_map_toggle" value="0" <?php if (!$footer_map_toggle) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="footer_map" rows="10" class="form-control"><?php echo $footer_map; ?></textarea>
										</div>
									</div>
								</div>
								...
								<div class="tab-pane" id="tab-pay-icons">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="pay_icons_toggle" value="1" <?php if ($pay_icons_toggle) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="pay_icons_toggle" value="0" <?php if (!$pay_icons_toggle) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<select name="pay_icons_banner_id" class="form-control">
												<option value="-99">-- Выбрать --</option>
												<?php foreach ($banners as $banner) { ?>
												<?php if ($banner['banner_id'] == $pay_icons_banner_id) { ?>
								...
								<div class="tab-pane" id="tab-category-page">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="left_subcategory" value="1" <?php if ($left_subcategory) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="left_subcategory" value="0" <?php if (!$left_subcategory) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="category_description_position" value="1" <?php if ($category_description_position) { echo 'checked'; } ?> /> Верх
											</label>
											<label class="radio-inline">
												<input type="radio" name="category_description_position" value="0" <?php if (!$category_description_position) { echo 'checked';} ?> /> Низ
											</label>
										</div>
									</div>
								</div>
								...
								<div class="tab-pane" id="tab-product-page">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="product_short_description" value="1" <?php if ($product_short_description) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="product_short_description" value="0" <?php if (!$product_short_description) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="product_short_attributes" value="1" <?php if ($product_short_attributes) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="product_short_attributes" value="0" <?php if (!$product_short_attributes) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="product_social_likes" value="1" <?php if ($product_social_likes) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="product_social_likes" value="0" <?php if (!$product_social_likes) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="related_product_position" value="1" <?php if ($related_product_position) { echo 'checked'; } ?> /> Под описанием товара
											</label>
											<label class="radio-inline">
												<input type="radio" name="related_product_position" value="0" <?php if (!$related_product_position) { echo 'checked';} ?> /> Над описанием товара
											</label>
										</div>
									</div>
								</div>
								...
								<div class="tab-pane" id="tab-general-settings">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="disable_cart_button" value="1" <?php if ($disable_cart_button) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="disable_cart_button" value="0" <?php if (!$disable_cart_button) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<div class="input-group">
												...
												<input name="disable_cart_button_text[<?php echo $language['language_id']; ?>]" value="<?php echo $disable_cart_button_text[$language['language_id']]; ?>" class="form-control" />
											</div>
											<?php } ?>
										</div>
									</div>
									<hr>
									<div class="form-group">
										<label class="col-sm-2 control-label">Включить быстрый просмотр товаров</label>
										<div class="col-sm-10">
											<label class="radio-inline">
												<input type="radio" name="on_off_qview" value="1" <?php if ($on_off_qview) { echo 'checked'; } ?> /> Да
											</label>
											<label class="radio-inline">
												<input type="radio" name="on_off_qview" value="0" <?php if (!$on_off_qview) { echo 'checked';} ?> /> Нет
											</label>
										</div>
									</div>
									<hr>
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<div class="input-group">
												...
												<input name="col_left_button_text[<?php echo $language['language_id']; ?>]" value="<?php echo $col_left_button_text[$language['language_id']]; ?>" class="form-control" />
											</div>
											<?php } ?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<div class="input-group">
												...
												<input name="col_right_button_text[<?php echo $language['language_id']; ?>]" value="<?php echo $col_right_button_text[$language['language_id']]; ?>" class="form-control" />
											</div>
											<?php } ?>
										</div>
									</div>
...
function addNewHomeModule() {
	...
	html += '  <td><select name="new_home_layout_module[' + new_home_module_row + '][code]" class="form-control">';
	<?php foreach ($new_home_extensions as $extension) { ?>    
	<?php if (!$extension['module']) { ?>
	...
	<?php } ?>
    html += '  </select></td>'; 
	html += '  <td><select name="new_home_layout_module[' + new_home_module_row + '][position]" class="form-control">';
    ...
    html += '  </select></td>';
	html += '  <td><input type="text" name="new_home_layout_module[' + new_home_module_row + '][sort_order]" value="" placeholder="" class="form-control" /></td>';
...
function addItemHelp() {
  ...
  html += '<td class="text-left">';
	...
	html += '<input class="form-control" type="text" name="help_menu_item[' + item_row_help + '][title][<?php echo $language['language_id']; ?>]" value="" />';
	html += '</div>';
	<?php } ?>
	html += '</td>';	
	html += '<td class="text-left">';
	<?php foreach ($languages as $language) { ?>
	html += '<div class="input-group pull-left"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>';
	html += '<input class="form-control"  type="text" name="help_menu_item[' + item_row_help + '][link][<?php echo $language['language_id']; ?>]" value="" />';
	html += '</div>';
	<?php } ?>
	html += '</td>';
	html += '<td class="text-left"><input class="form-control" type="text" name="help_menu_item[' + item_row_help + '][sort]" size="1" value="" /></td>';
...
function addItemMain() {
  ...
  html += '<td class="text-left">';
	<?php foreach ($languages as $language) { ?>
	html += '<div class="input-group pull-left"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>';
	html += '<input class="form-control" type="text" name="main_menu_item[' + item_row_main + '][title][<?php echo $language['language_id']; ?>]" value="" />';
	html += '</div>';
	<?php } ?>
	html += '</td>';
	html += '<td class="text-left">';
	<?php foreach ($languages as $language) { ?>
	html += '<div class="input-group pull-left"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>';
	html += '<input class="form-control"  type="text" name="main_menu_item[' + item_row_main + '][link][<?php echo $language['language_id']; ?>]" value="" />';
	html += '</div>';
	<?php } ?>
	html += '</td>';
	html += '<td class="text-left"><input class="form-control" type="text" name="main_menu_item[' + item_row_main + '][sort]" size="1" value="" /></td>';
...
function addItemCont() {
  html  = '<tr id="item-row-cont' + cont_item_row + '">';
	html += '<td class="text-left"><a href="" id="thumb-image-cont' + cont_item_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>"  /></a><input type="hidden" name="header_contact[' + cont_item_row + '][image]" value="" id="input-image-cont' + cont_item_row + '" /></td>';
  html += '<td class="text-left">';
	<?php foreach ($languages as $language) { ?>
	html += '<div class="input-group pull-left"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>';
	html += '<input class="form-control" type="text" name="header_contact[' + cont_item_row + '][title][<?php echo $language['language_id']; ?>]" value="" />';
	html += '</div>';
	<?php } ?>
	html += '</td>';
	html += '<td class="text-left"><input class="form-control" type="text" name="header_contact[' + cont_item_row + '][sort]" size="1" value="" /></td>';
...
function addItemContAdd() {
  html  = '<tr id="item-row-add-cont' + add_cont_item_row + '">';
	html += '<td class="text-left"><a href="" id="thumb-image-add-cont' + add_cont_item_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>"  /></a><input type="hidden" name="additional_contact[' + add_cont_item_row + '][image]" value="" id="input-image-add-cont' + add_cont_item_row + '" /></td>';
  html += '<td class="text-left">';
	<?php foreach ($languages as $language) { ?>
	html += '<div class="input-group pull-left"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>';
	html += '<input class="form-control" type="text" name="additional_contact[' + add_cont_item_row + '][title][<?php echo $language['language_id']; ?>]" value="" />';
	html += '</div>';
	<?php } ?>
	html += '</td>';
	html += '<td class="text-left">';
	<?php foreach ($languages as $language) { ?>
	html += '<div class="input-group pull-left"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>';
	html += '<input class="form-control" type="text" name="additional_contact[' + add_cont_item_row + '][link][<?php echo $language['language_id']; ?>]" value="" />';
	html += '</div>';
	<?php } ?>
	html += '</td>';
	html += '<td class="text-left"><input class="form-control" type="text" name="additional_contact[' + add_cont_item_row + '][sort]" size="1" value="" /></td>';
...
function addItemCatLinks() {
  ...
  html += '<td class="text-left">';
	<?php foreach ($languages as $language) { ?>
	html += '<div class="input-group pull-left"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>';
	html += '<input class="form-control" type="text" name="add_cat_links_item[' + item_row_cat_links + '][title][<?php echo $language['language_id']; ?>]" value="" />';
	html += '</div>';
	<?php } ?>
	html += '</td>';
	html += '<td class="text-left">';
	<?php foreach ($languages as $language) { ?>
	html += '<div class="input-group pull-left"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>';
	html += '<input class="form-control"  type="text" name="add_cat_links_item[' + item_row_cat_links + '][link][<?php echo $language['language_id']; ?>]" value="" />';
	html += '</div>';
	<?php } ?>
	html += '</td>';
	html += '<td class="text-left"><input class="form-control" type="text" name="add_cat_links_item[' + item_row_cat_links + '][sort]" size="1" value="" /></td>';
