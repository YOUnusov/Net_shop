<div id="search" class="input-group">	
    ...
    <button id="change_category" type="button" class="btn dropdown-toggle" data-toggle="dropdown">
			...
			<span class="category-name"><?php echo $search_text_category; ?></span> <span class="caret"></span>
		</button>
    <ul class="dropdown-menu">
			<li><a href="#" onclick="return false;" id="0"><?php echo $search_text_category; ?></a></li>
