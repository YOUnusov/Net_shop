				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-3 ">
						...
						<div class="btn-group">
							<button type="button" id="grid-view" class="btn btn-default">
								<i class="fa fa-th fa-fw"></i><span class=" hidden-sm <?php if ($twocols) {echo 'hidden-lg';} ?>"> <?php echo $button_grid; ?></span>
							</button>
						</div>
						<div class="btn-group">
							<button type="button" id="list-view" class="btn btn-default">
								<i class="fa fa-th-list fa-fw"></i><span class=" hidden-sm <?php if ($twocols) {echo 'hidden-lg';} ?>"> <?php echo $button_list; ?></span>
							</button>
						</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-5 ">
						<div class="input-group select-style">
							<span class="input-group-addon" data-toggle="tooltip" data-placement="top" title="<?php echo $text_sort; ?>"><i class="fa fa-sort fa-fw"></i></span>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 ">
						<div class="input-group">
							<span class="input-group-addon" data-toggle="tooltip" data-placement="top" title="<?php echo $text_limit; ?>"><i class="fa fa-eye fa-fw"></i></span></span>
                ...
                <?php } ?>
                  ...
                  <i class="fa fa-star-o"></i>
								...
								<div class="btn-group">
									...
									<?php } else { ?>
									<button class="btn btn-addtocart" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-basket"></i> <span class="hidden-xs hidden-sm hidden-md">&nbsp;<?php echo $button_cart; ?></span></button>
									<?php } ?>
									<?php if ($on_off_qview){ ?>
