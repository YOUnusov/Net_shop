  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-xds-custom-blocks" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-xds-custom-blocks" class="form-horizontal">
            ...
            <div class="col-sm-10">
              <select name="status" id="input-status" class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
            <label class="col-sm-2 control-label" for="input-columns">Блоков в строку</label>
            <div class="col-sm-10">
              <select name="columns" id="input-columns" class="form-control">
                ...
                <option value="2" <?php if ($columns == 2) { echo 'selected'; }?>>2</option>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-blocks">Блоки</label>
						<div class="col-sm-10">
...
function addItem() {
  ...
  html += '<td class="text-left">';
	...
	<?php } ?>
	html += '</td>';
	html += '<td class="text-left"><input class="form-control" type="text" name="cust_blocks_item[' + item_row + '][sort]" size="1" value="0" /></td>';
