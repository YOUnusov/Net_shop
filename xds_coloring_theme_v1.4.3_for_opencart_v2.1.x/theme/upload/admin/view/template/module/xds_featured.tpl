  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-xds-featured" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-xds-featured" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <div id="xds_featured-product" class="well well-sm" style="height: 150px; overflow: auto;">
                <?php foreach ($products as $product) { ?>
                <div id="xds_featured-product<?php echo $product['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product['name']; ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="width" value="<?php echo $width; ?>" placeholder="<?php echo strip_tags($entry_width); ?>" id="input-width" class="form-control" />
              <?php if ($error_width) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="height" value="<?php echo $height; ?>" placeholder="<?php echo strip_tags($entry_height); ?>" id="input-height" class="form-control" />
              <?php if ($error_height) { ?>
...
$('input[name=\'product\']').autocomplete({
	...
	select: function(item) {
		...
		$('#xds_featured-product' + item['value']).remove();
		
		$('#xds_featured-product').append('<div id="xds_featured-product' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product[]" value="' + item['value'] + '" /></div>');	
	}
});
	
$('#xds_featured-product').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
//--></script></div>
<?php echo $footer; ?>