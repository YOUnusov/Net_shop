<div class="list-group">
  ...
  <a href="<?php echo $address; ?>" class="list-group-item"><i class="fa fa-building-o list-group-icon"></i>&nbsp;&nbsp;<?php echo $text_address; ?></a>
	<a href="<?php echo $wishlist; ?>" class="list-group-item"><i class="fa fa-heart-o list-group-icon"></i>&nbsp;&nbsp;<?php echo $text_wishlist; ?></a>
	<a href="<?php echo $order; ?>" class="list-group-item"><i class="fa fa-history list-group-icon"></i>&nbsp;&nbsp;<?php echo $text_order; ?></a>
	<a href="<?php echo $download; ?>" class="list-group-item"><i class="fa fa-download list-group-icon"></i>&nbsp;&nbsp;<?php echo $text_download; ?></a>
	<a href="<?php echo $reward; ?>" class="list-group-item"><i class="fa fa-diamond list-group-icon"></i>&nbsp;&nbsp;<?php echo $text_reward; ?></a>
	<a href="<?php echo $return; ?>" class="list-group-item"><i class="fa fa-exchange list-group-icon"></i>&nbsp;&nbsp;<?php echo $text_return; ?></a>
	<a href="<?php echo $transaction; ?>" class="list-group-item"><i class="fa fa-credit-card list-group-icon"></i>&nbsp;&nbsp;<?php echo $text_transaction; ?></a>
	<a href="<?php echo $newsletter; ?>" class="list-group-item"><i class="fa fa-envelope-o list-group-icon"></i>&nbsp;&nbsp;<?php echo $text_newsletter; ?></a>
	<a href="<?php echo $recurring; ?>" class="list-group-item"><i class="fa fa-clock-o list-group-icon"></i>&nbsp;&nbsp;<?php echo $text_recurring; ?></a>
  <?php if ($logged) { ?>
